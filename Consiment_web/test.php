...
$Recordset1 = mysql_query($query_limit_Recordset1, $mydb) or die(mysql_error());
...
<table width="866" border="1">
  <tbody>
    ...
    <tr>
      <th scope="row"><?php echo $row_Recordset1['Number_ID']; ?></th>
      <td><?php echo $row_Recordset1['FName']; ?></td>
      <td><?php echo $row_Recordset1['Lname']; ?></td>
      <td><?php echo $row_Recordset1['Birth_Date']; ?></td>
